...
app = modal.App("whisper-large-v3-dioula-finetune")
...
def train_whisper_remote():
    ...
    wandb.init(
        ...
        config={
            ...
            "method": "LoRA + SpecAugment + Fixed Generation Rem Darurat",
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir="/output/checkpoints_split8020",
        ...
        logging_steps=50,
        report_to="wandb",
        run_name="whisper-large-v3-dioula-final-project"
    )
    ...
    last_checkpoint = get_last_checkpoint("/output/checkpoints_split8020")
    ...
    final_output_path = "/output/whisper-large-v3-dioula-split8020-final"
