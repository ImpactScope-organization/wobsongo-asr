...
app = modal.App("whisper-small-no-aug-dioula-finetune")
...
def train_whisper_remote():
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir="/output/checkpoints_small_plit8020_NO_AUG",
    ...
    last_checkpoint = get_last_checkpoint("/output/checkpoints_small_plit8020_NO_AUG")
