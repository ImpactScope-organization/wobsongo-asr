...
print(f"[PROC] whisper-small (aug) | LOCAL_RANK={LOCAL_RANK}, "
...
training_args = Seq2SeqTrainingArguments(
    ...
    logging_steps=50,
    report_to="wandb",
    run_name="whisper-small-dioula-singlenode",
...
if is_main_process:
    wandb.init(
        ...
        resume="allow",
        name="whisper-small-dioula-singlenode",
        config={
...
if is_main_process:
    ...
    model_volume.commit()
    print("Done! whisper-small (aug) training complete.")
    wandb.finish()